                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="match-left">
                          <div class="mtl-left"> <img src="{{url ('assets/images/mlogo1.png')}}" alt=""> <strong>North Carolina</strong> </div>
                      ...
                      <div class="col-sm-4">
                        <div class="match-right">
                          ...
                          <div class="mtl-right"> <img src="{{url ('assets/images/mlogo2.png')}}" alt=""> <strong>Indy Eleven</strong> </div>
                          <ul>
