               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-lg-8">
                        <div class="row">
                           ...
                           <div class="col-md-8">
                              ...
                              <img src="{{url ('assets/images/advertisehere.jpg')}}" alt="" class="img-responsive"> 
                           </div>
                           <!--Match Results End--> 
                        </div>
                        <!--Team Prograss Start-->
                        ...
                        <div class="watchvideohighlights">
                           ...
                           <div class="video-img"> <a href="#"><i class="far fa-play-circle"></i></a>
                            <img src="{{url ('assets/images/videoimg.jpg')}}" alt=""> </div>
                        </div>
                        <!--Video End-->
                        ...
                        <div class="match-image-collection">
                           ...
                           <img src="{{url ('assets/images/nlarge5.jpg')}}" alt=""> 
                        </div>
                     </div>
                     <!--News End--> 
                     <!--Sidebar Start-->
                     <div class="col-lg-4">
                        <div class="sidebar">
                           <!--widget start-->
                           <div class="widget sidebar-ad"> <img src="{{url ('assets/images/sideadbanner1.png')}}" alt=""> </div>
                           <!--widget end--> 
                           <!--widget start-->
                           <div class="widget">
