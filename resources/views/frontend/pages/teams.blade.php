            ...
            <div class="col-md-6">
              <div class="player-box with-extra-info">
                ...
                <div class="player-txt">
                  <h3>Dewey Mason</h3>
                  <strong class="player-desi">Head Coach</strong>
				  ...
				  <li>Past Teams <strong>FU, BZU Team</strong></li>
				  <li>Seasons <strong>2015, 2018, 2020</strong></li>
                  </ul>
                 <a href="#" class="follow">Follow</a> </div>
              </div>
            </div>
            <!--Player Box End--> 
          ...
          <div class="row"> 
            ...
            <div class="col-lg-3 col-md-6">
              <div class="team-squad-box">
                ...
                <img src="{{url ('assets/images/tplayer5.jpg')}}" alt=""> </div>
            </div>
            <!--Team Box End--> 
            ...
            <div class="col-lg-3 col-md-6">
              <div class="team-squad-box">
                ...
                <img src="{{url ('assets/images/tplayer6.jpg')}}" alt=""> </div>
            </div>
            <!--Team Box End-->
