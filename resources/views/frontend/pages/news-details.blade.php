              ...
              <div class="col-lg-8">
                <div class="news-details-wrap">
                  <div class="news-large-post">
                    <div class="post-thumb"> <img src="{{url ('assets/images/nlarge2.jpg')}}" alt=""></div>
                    <div class="post-txt">
                      ...
                      <ul class="small-gallery">
                        <li><img src="{{url ('assets/images/ndimg1.jpg')}}" alt=""></li>
                        <li><img src="{{url ('assets/images/ndimg2.jpg')}}" alt=""></li>
                        <li><img src="{{url ('assets/images/ndimg3.jpg')}}" alt=""></li>
                      </ul>
                    </div>
                    <div class="post-bottom">
                      ...
                      <div class="post-author-box">
                        <img src="{{url ('assets/images/postauthor.jpg')}}" alt="">
                        <h4>About Author</h4>
                      ...
                      <div class="post-comments">
                        ...
                        <ul class="comments">
                          <li class="comment">
                            <div class="user-thumb"><img src="{{url ('assets/images/cuser1.jpg')}}" alt=""></div>
                            ...
                            <ul class="child-comments">
                              <li class="comment">
                                <div class="user-thumb"><img src="{{url ('assets/images/cuser2.jpg')}}" alt=""></div>
                                <div class="user-comments">
                              ...
                              <li class="comment">
                                <div class="user-thumb"><img src="{{url ('assets/images/cuser3.jpg')}}" alt=""></div>
                                <div class="user-comments">
                          ...
                          <li class="comment">
                            <div class="user-thumb"><img src="{{url ('assets/images/cuser4.jpg')}}" alt=""></div>
                            <div class="user-comments">
