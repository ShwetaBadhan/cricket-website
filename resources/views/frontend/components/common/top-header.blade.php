<div class="h3-match-counter">
    ...
    <div class="container">
        <div class="row">
            <ul>
                <li class="col-md-1">
                    <div class="team-left"><img src="{{ url('asset/images/nmf-logo1.png') }}" alt=""> <strong>FC Champs</strong></div>
                </li>
                <li class="col-md-3">
                ...
                <li class="col-md-1">
                    <div class="team-right"><img src="{{ url('asset/images/nmf-logo2.png') }}" alt=""> <strong>Tigers</strong></div>
                </li>
            </ul>
        </div>
    </div>
