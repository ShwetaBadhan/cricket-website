            ...
            <li class="lang-btn">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"> <a class="dropdown-item"
                  ...
                  <a class="dropdown-item" href="#">AR</a> </div>
              </div>
            </li>
            <li class="currency-btn">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="currencydropdown"> <a class="dropdown-item" href="#">USD</a>
                  <a class="dropdown-item" href="#">Euro</a> <a class="dropdown-item" href="#">Pound</a> </div>
              </div>
            </li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 col-sm-5">
          <div class="logo"><a href="{{ route('index') }}"><img src="{{url('assets/images/logo-dark.png')}}"
                alt=""></a></div>
        </div>
        <div class="col-md-10 col-sm-7">
          <nav class="main-nav">
            <ul>
              ...
              <li class="nav-item drop-down"> <a href="javascript:void(0)">Matches</a>
                <ul>
              ...
              <li class="nav-item drop-down"> <a href="javascript:void(0)">Players</a>
                <ul>
                  <li><a href="{{ route('our-team') }}">Teams</a></li>
