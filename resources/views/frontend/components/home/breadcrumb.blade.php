                ...
                <ul>
                    <li data-transition="fade"> <img src="{{url('assets/images/slide1-bg.jpg')}}" alt="" width="1920"
                        ...
                        <div class="tp-caption  tp-resizeme" data-x="right" data-hoffset="350" data-y="top"
                            ...
                            data-start="700">
                            <div class="slide-content-box"> <img src="{{url('assets/images/slide1-player.png')}}"
                                    alt=""> </div>
                        </div>
                        <div class="tp-caption  tp-resizeme" data-x="right" data-hoffset="850" data-y="bottom"
                            ...
                            data-mask_in="x:[100%];y:0;s:inherit;e:inherit;" data-splitin="none" data-splitout="none"
                            data-start="700">
                            <div class="slide-content-box"> <img src="{{url('assets/images/slide1-football.png')}}"
                                    alt=""> </div>
                        </div>
                    ...
                    <li data-transition="fade"> <img src="{{url('assets/images/slide3bg.jpg')}}" alt="" width="1920"
                        ...
                        <div class="tp-caption  tp-resizeme" data-x="right" data-hoffset="350" data-y="top"
                            ...
                            data-mask_in="x:[100%];y:0;s:inherit;e:inherit;" data-splitin="none" data-splitout="none"
                            data-start="700">
                            <div class="slide-content-box"> <img src="{{url('assets/images/slide3player.png')}}" alt="">
                            </div>
                        </div>
                        <div class="tp-caption  tp-resizeme" data-x="left" data-hoffset="400" data-y="top"
                            data-voffset="205" data-transform_idle="o:1;"
