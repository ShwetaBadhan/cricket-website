@php
    $Homebenefits = App\Models\HomeBenefit::where('is_active', true)->first() ?? new \App\Models\HomeBenefit();
@endphp
    ...
    <div class="hg-services-container">
        ...
        <div class="hg-services-cards">
            ...
            <div class="hg-service-card hg-card-red">
                <div class="hg-card-icon">
                    <!-- <i class="fas fa-baseball-ball"></i> -->
                     <img src="{{ $Homebenefits->small_card_1_image ? asset('storage/'.$Homebenefits->small_card_1_image) : asset('assets/images/fav.png') }}" alt="Cricket Ball Icon" class="cricket-icon">
                </div>
            ...
            <div class="hg-service-card hg-card-yellow">
                <div class="hg-card-icon">
                    <img src="{{ $Homebenefits->small_card_2_image ? asset('storage/'.$Homebenefits->small_card_2_image) : asset('assets/images/fav.png') }}" alt="Cricket Ball Icon" class="cricket-icon">
                </div>
            ...
            <div class="hg-service-card hg-card-green">
                <div class="hg-card-icon">
                    <img src="{{ $Homebenefits->small_card_3_image ? asset('storage/'.$Homebenefits->small_card_3_image) : asset('assets/images/fav.png') }}" alt="Cricket Ball Icon" class="cricket-icon">
                </div>
            ...
            <div class="hg-service-card hg-card-purple">
                <div class="hg-card-icon">
                   <img src="{{ $Homebenefits->small_card_4_image ? asset('storage/'.$Homebenefits->small_card_4_image) : asset('assets/images/fav.png') }}" alt="Cricket Ball Icon" class="cricket-icon">
                </div>
