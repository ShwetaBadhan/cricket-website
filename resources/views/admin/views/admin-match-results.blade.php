...
<div class="modal custom-modal fade" id="view_match{{ $matchResult->id }}" role="dialog"
    data-score='@json($matchResult->score_data)'>
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="sport_type" class="form-control edit-sport">
                                <option value="cricket" {{ $matchResult->sport_type == 'cricket' ? 'selected' : '' }}>
                                    Cricket
                                </option>
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="inactive" {{ $matchResult->status == 'inactive' ? 'selected' : '' }}>
                                    Inactive
                                </option>
                            </select>
                        </div>
