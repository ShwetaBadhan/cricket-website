                                                ...
                                                <td class="d-flex align-items-center">
                                                    @can('view nodal registration')
                                                        <a class="btn-action-icon me-2" href="javascript:void(0);"
                                                            ...
                                                            data-bs-target="#view_lead{{ $nodalRegistration->id }}">
                                                            <i class="fe fe-eye"></i>
                                                        </a>
                                                    @endcan
                                                    @can('delete nodal registration')
                                                        ...
                                                        <form
                                                            action="{{ route('admin-nodal-registration.destroy', $nodalRegistration->id) }}"
