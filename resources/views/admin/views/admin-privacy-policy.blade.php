                ...
                <div class="col-lg-12">
                    <div class="card border shadow-sm h-100">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0"><i class="fas fa-info-circle"></i> Privacy Policy Section</h5>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="main_title"
                                                ...
                                                required>{{ old('main_title', $privacyPolicy->main_title) }}</textarea>
                                            @error('main_title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="sub_title"
                                                ...
                                                required>{{ old('sub_title', $privacyPolicy->sub_title) }}</textarea>
                                            @error('sub_title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description_1"
                                                ...
                                                required>{{ old('description_1', $privacyPolicy->description_1) }}</textarea>
                                            @error('description_1')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
