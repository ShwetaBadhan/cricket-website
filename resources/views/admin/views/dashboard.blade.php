                            ...
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card w-100">
                                    ...
                                    <div class="dash-comapny-info">
                                        ...
                                        <h5>987</h5>
                                        <p>
                                            <span>14% <i class="fe fe-chevrons-up"></i></span>Last
                                            month
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card bg-info-light w-100">
                                    ...
                                    <div class="dash-comapny-info">
                                        ...
                                        <h5>154</h5>
                                        <p>
                                            <span>1% <i class="fe fe-chevrons-up"></i></span>Last
                                            month
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card bg-pink-light w-100">
                                    ...
                                    <div class="dash-comapny-info">
                                        ...
                                        <h5>2</h5>
                                        <p>
                                            <span>2% <i class="fe fe-chevrons-up"></i></span>Last
                                            month
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card bg-success-light w-100">
                                    ...
                                    <div class="dash-comapny-info">
                                        ...
                                        <h5>6</h5>
                                        <p>
                                            <span>6% <i class="fe fe-chevrons-up"></i></span>Last
                                            month
                                        </p>
                                    </div>
                                </div>
                                                    ...
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                                            ...
                                                            <img class="avatar-img rounded-circle company"
                                                                src="{{ asset('admin/assets/img/companies/company-01.svg') }}"
                                                                alt="Company Image" /></a>
                                                        <a href="companies.html">Hermann Groups
                                                            <span class="plane-type">Basic (Monthly)</span></a>
                                                    </h2>
                                                </td>
                                                <td>24 Feb 2024</td>
                                                <td class="text-end">
                                                    <a href="companies.html" class="view-companies btn">View</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                                            class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company"
                                                                src="{{ asset('admin/assets/img/companies/company-02.svg') }}"
                                                                alt="Company Image" /></a>
                                                        <a href="companies.html">Skiles LLC
                                                            <span class="plane-type">Enterprise (Yearly)</span></a>
                                                    </h2>
                                                </td>
                                                <td>23 Feb 2024</td>
                                                <td class="text-end">
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                                            class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company"
                                                                src="{{ asset('admin/assets/img/companies/company-03.svg') }}"
                                                                alt="Company Image" /></a>
                                                        <a href="companies.html">Kerluke Group
                                                            <span class="plane-type">Advanced (Monthly)</span></a>
                                                    </h2>
                                                </td>
                                                <td>22 Feb 2024</td>
                                                <td class="text-end">
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                                            class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company"
                                                                src="{{ asset('admin/assets/img/companies/company-04.svg') }}"
                                                                alt="Company Image" /></a>
                                                        <a href="companies.html">Schowalter Group
                                                            <span class="plane-type">Basic (Yearly)</span></a>
                                                    </h2>
                                                </td>
                                                <td>21 Feb 2024</td>
                                                <td class="text-end">
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                                            class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company"
                                                                src="{{ asset('admin/assets/img/companies/company-05.svg') }}"
                                                                alt="Company Image" /></a>
                                                        <a href="companies.html">Accentric Global
                                                            <span class="plane-type">Basic (Monthly)</span></a>
                                                    </h2>
                                                </td>
                                                <td>20 Feb 2024</td>
                                ...
                                <div class="dash-plane-list">
                                    <div class="plane-info">
                                        <span class="icon-plane"><img
                                                src="{{ asset('admin/assets/img/icons/dashboard-plane-icon.svg') }}"
                                                alt="" /></span>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="invoice-details.html"
                                                        ...
                                                        class="dash-incoice-date">15 Feb 2024</span>
                                                </td>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                                ...
                                                <td>
                                                    Basic <br />
                                                    <span class="plane-type">(Monthly)</span>
                                                </td>
                                                <td>
                                                    <span class="badge bg-success-light d-inline-flex align-items-center"><i
                                                            class="fe fe-check me-1"></i>Paid</span>
                                                </td>
                                                <td class="text-end">
                                                    <a href="invoice-subscription.html" class="invoice-detail"><i
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="invoice-details.html"
                                                        ...
                                                        class="dash-incoice-date">14 Feb 2024</span>
                                                </td>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                                ...
                                                <td>
                                                    Enterprise <br />
                                                    <span class="plane-type">(Yearly)</span>
                                                </td>
                                                <td>
                                                    <span class="badge bg-danger-light d-inline-flex align-items-center"><i
                                                            class="fe fe-x me-1"></i>Unpaid</span>
                                                </td>
                                                <td class="text-end">
                                                    <a href="invoice-subscription.html" class="invoice-detail"><i
                                                            class="fe fe-file-text"></i></a>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="invoice-details.html"
                                                        ...
                                                        class="dash-incoice-date">13 Feb 2024</span>
                                                </td>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="invoice-details.html"
                                                        ...
                                                        class="dash-incoice-date">12 Feb 2024</span>
                                                </td>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="invoice-details.html"
                                                        ...
                                                        class="dash-incoice-date">11 Feb 2024</span>
                                                </td>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="profile.html"
