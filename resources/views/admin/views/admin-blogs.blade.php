                                        ...
                                        @forelse ($blogs as $blog)
                                            <tr>
                                                ...
                                                <td><a href="" class="product-list-item-img"><img
                                                            ...
                                                            alt="product-list"><span>{{ $blog->title }}</span></a></td>
                                                <td>{{ $blog->author }} </td>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <small class="form-text text-muted">Size : 40 * 40(max size : 5MB)</small>
                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($item->author_image)
                                        <img src="{{ asset('storage/' . $item->author_image) }}" width="60" class="rounded-circle">
                                    @endif
                                </td>
                            </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @if($blog->author_image)
                                        <img src="{{ asset('storage/' . $blog->author_image) }}" width="80" class="mt-2">
                                    @endif
                                </div>
