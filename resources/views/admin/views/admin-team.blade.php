                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" class="product-list-item-img">
                                                        <img src="{{ $team->image ? asset('storage/' . $team->image) : asset('placeholder.png') }}"
                                                            alt="team">
                                                        <span>{{ $team->name }}</span>
                                                    </a>
                                                </td>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    ...
                                                    @can('view team')
                                                        <a class="btn-action-icon me-2" href="javascript:void(0);"
                                                            data-bs-toggle="modal" data-bs-target="#view_team{{ $team->id }}">
                                                            <i class="fe fe-eye"></i>
                                                        </a>
                                                    @endcan
                                                    @can('edit team')
                    ...
                    <form action="{{ route('admin-team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-3">
                                    <label>Facebook</label>
                                    <input type="url" name="facebook_link" placeholder="facebook url" class="form-control"
                                        value="{{ $team->facebook_link }}">
                                </div>

                                <div class="col-lg-4 mb-3">
                                    <label>Twitter</label>
                                    <input type="url" name="twitter_link" placeholder="twitter url" class="form-control"
                                        value="{{ $team->twitter_link }}">
                                </div>

                                <div class="col-lg-4 mb-3">
                                    <label>Instagram</label>
                                    <input type="url" name="instagram_link" placeholder="instagram url" class="form-control"
