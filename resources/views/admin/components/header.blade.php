<div class="header header-one">
    <a href="{{ route('dashboard') }}"
        ...
        <img src="{{ asset('assets/images/logo/white-jss.png')}}" class="img-fluid logo2" alt="Logo" />
    </a>
    <div class="main-logo d-inline float-start d-lg-flex align-items-center d-none d-sm-none d-md-none">
        <div class="logo-white">
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('assets/images/logo/jss.png')}}" class="img-fluid logo-blue" alt="Logo" />
            </a>
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('assets/images/logo/white-jss.png')}}" class="img-fluid logo-small" alt="Logo" />
            </a>
        </div>
        <div class="logo-color">
            ...
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('assets/images/logo/fav.png')}}" class="img-fluid logo-small" alt="Logo" />
            </a>
        </div>
    </div>
    ...
    <ul class="nav nav-tabs user-menu">
        ...
        <li class="nav-item dropdown has-arrow flag-nav">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button">
                <img src="{{ asset('admin/assets/img/flags/us1.png') }}" alt="flag" /><span>English</span>
            </a>
            <div class="dropdown-menu dropdown-menu-end">
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('admin/assets/img/flags/us.png') }}" alt="flag" /><span>English</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('admin/assets/img/flags/fr.png') }}" alt="flag" /><span>French</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('admin/assets/img/flags/es.png') }}" alt="flag" /><span>Spanish</span>
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('admin/assets/img/flags/de.png') }}" alt="flag" /><span>German</span>
                </a>
            </div>
        </li>
        <!-- /Flag -->
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    <span class="avatar avatar-md active">
                                        <img class="avatar-img rounded-circle" alt="avatar-img"
                                            src="{{ asset('admin/assets/img/profiles/avatar-10.jpg') }}" />
                                    </span>
                                    <div class="media-body">
                                        <p class="noti-details">
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details">
                                            <span class="noti-title">Dennis Nedry</span>
                                            commented on
                                            <span class="noti-title">
                                                Isla Nublar SOC2 compliance report</span>
                                        </p>
                                        <blockquote>
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    <span class="avatar avatar-md">
                                        <img class="avatar-img rounded-circle" alt="avatar-img"
                                            src="{{ asset('admin/assets/img/profiles/avatar-05.jpg') }}" />
                                    </span>
                                    <div class="media-body">
                                        <p class="noti-details">
                                            <span class="noti-title">John Hammond</span> created
